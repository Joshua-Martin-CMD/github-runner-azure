...
#Input Github Runner Version ARG
ARG RUNNER_VERSION
ENV DEBIAN_FRONTEND=noninteractive

## Labels
LABEL Author="Joshua CMD"
LABEL Email="joshua.martin@cmd.com.au"
LABEL github="https://github.com/Joshua-Martin-CMD/github-runner-azure"
